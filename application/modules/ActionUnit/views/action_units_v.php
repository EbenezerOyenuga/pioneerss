                                ...
                                <div class="row" id="students">
                                  ...
                                  <div class="col-md-12">
                                      <div class="panel panel-default">
                                          ...
                                          <div class="panel-body">
                                              <?php if (isset($_SESSION['message'])) echo $_SESSION['message'];?>
                                            <form method="POST" class="form-horizontal" action = "<?php echo base_url(); ?>ActionUnit/download_action_unit_students">
                                              <table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                                                  <thead>
                                                  <tr>
                                                      <th>S/N</th>
                                                      ...
                                                      <div class="row">
                                                          <div class="col-md-12">
                                                              ...
                                                              <div class="form-group">
                                                                      ...
                                                                      <button class="btn btn-primary" type="submit" name="download" value="download">Download Students Report</button>
